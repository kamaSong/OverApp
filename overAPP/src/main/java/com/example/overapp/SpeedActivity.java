...
public class SpeedActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardImg = findViewById(R.id.card_speed_circle);
        cardImg.setOnClickListener(this);
        layoutPause = findViewById(R.id.layout_speed_pause);
        layoutPause.setOnClickListener(this);
        layoutHome = findViewById(R.id.layout_speed_home);
        layoutHome.setOnClickListener(this);
        layoutWord = findViewById(R.id.layout_speed_word);
        layoutWord.setOnClickListener(this);
        textProgress = findViewById(R.id.text_speed_top);
    ...
    private void playWord() {
        if (mediaPlayer != null) {
            ...
            mediaPlayer = new MediaPlayer();
        try {
            mediaPlayer.setDataSource(ConstantData.YOU_DAO_VOICE_UK + wordList.get(tem).getWord());
