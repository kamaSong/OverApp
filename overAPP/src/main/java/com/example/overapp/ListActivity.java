...
public class ListActivity extends AppCompatActivity {
    ...
    private final String[] sorts = {"全部单词", "收藏单词"};
...
//        初始化
        ...
        currentAllNumber = ConstantData.wordTotalNumber(LitePal.where("userId = ?", ConfigData.getNumLogged() + "").find(UserConfig.class).get(0).getCurrentBookId());
