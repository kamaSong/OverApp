...
import com.example.overapp.InterFace.CallBackListener;
...
import com.example.overapp.MatchActivity;
import com.example.overapp.OCRActivity;
import com.example.overapp.R;
import com.example.overapp.SpeedActivity;
import com.example.overapp.Utils.BaiduHelper;
import com.example.overapp.Utils.Base64Util;
...
public class FragmentReview extends Fragment implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        layoutPhoto = getActivity().findViewById(R.id.layout_review_photo);
        layoutPhoto.setOnClickListener(this);
        layoutSpeed = getActivity().findViewById(R.id.layout_review_speed);
        layoutSpeed.setOnClickListener(this);
        layoutMatch = getActivity().findViewById(R.id.layout_review_match);
