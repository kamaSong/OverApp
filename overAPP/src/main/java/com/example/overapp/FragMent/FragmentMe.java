...
import com.example.overapp.AboutActivity;
import com.example.overapp.AlarmActivity;
import com.example.overapp.CalendarActivity;
import com.example.overapp.ConfigData.ConfigData;
import com.example.overapp.MainActivity;
import com.example.overapp.PlanActivity;
...
public class FragmentMe extends Fragment  implements View.OnClickListener{
    ...
    private RelativeLayout layoutAlarm,  layoutAbout;
...
//        初始化
        ...
        List<User> userList = LitePal.where("userId = ?", ConfigData.getNumLogged() + "").find(User.class);
    ...
    private void updateData() {
        // 设置天数
        List<MyDate> myDateList = LitePal.where("userId = ?", ConfigData.getNumLogged() + "").find(MyDate.class);
